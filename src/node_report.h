...
void Triggernode-report(Isolate* isolate, DumpEvent event, const char* message, const char* location, char* name);

unsigned int ProcessNode_ReportEvents(const char* args);
